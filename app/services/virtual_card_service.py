...
from app.models.enums import Type, Currency, SplitStatus
...
def get_virtual_card_by_user_id(
    ...
    virtual_card: VirtualCard = db.scalar(select(VirtualCard).where(VirtualCard.user_id == user_id))
...
def create_virtual_card(
    ...
    card_exists = db.scalar(select(VirtualCard).where(VirtualCard.user_id == current_user.id))
...
def deposit_virtual_card(
    ...
    virtual_card: VirtualCard = db.scalar(select(VirtualCard)
...
def pay_debt(
    ...
    group_expense: GroupExpense = get_group_expense_by_id(db, expense_split.group_expense_id)
