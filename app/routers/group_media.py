...
from app.services.group_media_service import get_group_media, get_all_group_media, create_group_media
...
def upload_receipt(
    ...
    for f in files:
        key: str = minio_service.generate_object_key(group_id, MediaCategory.RECEIPT.name, f.filename)
